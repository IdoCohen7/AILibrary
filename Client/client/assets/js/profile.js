...
function ChangePassword(userId, newPassword) {
  let api =
    "https://proj.ruppin.ac.il/cgroup75/test2/tar1/api/User/ChangePassword?userId=" +
    userId +
    "&password=" +
    newPassword;
...
function ChangeUsername(userId, newName) {
  let api =
    "https://proj.ruppin.ac.il/cgroup75/test2/tar1/api/User/ChangeUsername?userId=" +
    userId +
    "&name= " +
    newName;
...
function ChangeProfilePicture(data) {
  ...
  userNewPicture = src;
  let api =
    "https://proj.ruppin.ac.il/cgroup75/test2/tar1/api/User/ChangeProfilePicture?userId=" +
    user.id +
    "&picture=" +
    src;
