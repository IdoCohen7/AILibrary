function Get16RandomBooks() {
    let api = "https://localhost:7063/api/Book/16Random";
    ajaxCall("GET", api, null, Get16RandomBooksSCB, Get16RandomBooksECB);
  }
  
  function Get16RandomBooksSCB(allBooks) {
    DisplayBooks(allBooks, "deck"); // Update the deck with random book thumbnails
  }
  
  function Get16RandomBooksECB(ERROR) {
    alert("ERROR: " + ERROR);
  }
  ...
  function DisplayBooks(books, containerId) {
    ...
    books.forEach(book => {
      ...
      addImage.setAttribute("src", book.thumbnail); // Assuming 'thumbnail' is the property for the image URL
      addImage.setAttribute("alt", "Book Cover");
